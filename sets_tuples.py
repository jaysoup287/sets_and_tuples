...
# print(set1[0]) # error: set object odes not support indexing 
for element in set1:
    print(element) #output true
print(1 in set1)   #output false
...
id_numbers = {198789, 22345, 763653, 334444, 239585}
id_numbers.pop()

id_numbers.add(100000)
print(id_numbers)
#tuples##################################
...
print(sample_list_of_fruit["fruits"][3])
